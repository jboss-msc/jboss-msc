...
public class ValueAlreadySetException extends IllegalStateException {
    ...
    /**
     * Constructs a {@code ValueAlreadySetException} with no detail message. The cause is not initialized, and may
    ...
    /**
     * Constructs a {@code ValueAlreadySetException} with the specified detail message. The cause is not initialized,
    ...
    /**
     * Constructs a {@code ValueAlreadySetException} with the specified cause. The detail message is set to:
    ...
    /**
     * Constructs a {@code ValueAlreadySetException} with the specified detail message and cause.
     *
     * @param msg the detail message
     * @param cause the cause (which is saved for later retrieval by the {@link #getCause()} method)
     */
