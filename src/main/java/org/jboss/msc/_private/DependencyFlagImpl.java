 ...
 */
public enum DependencyFlagImpl {
    ...
    private DependencyFlagImpl(boolean dependencyUp, boolean demand, boolean enforce) {
    ...
    public final boolean in(DependencyFlagImpl flag) {
        return this == flag;
    }

    public final boolean in(DependencyFlagImpl flag1, DependencyFlagImpl flag2) {
        return this == flag1 || this == flag2;
    }

    public final boolean in(DependencyFlagImpl flag1, DependencyFlagImpl flag2, DependencyFlagImpl flag3) {
        return this == flag1 || this == flag2 || this == flag3;
    }

    public final boolean in(DependencyFlagImpl flag1, DependencyFlagImpl flag2, DependencyFlagImpl flag3, DependencyFlagImpl flag4) {
        return this == flag1 || this == flag2 || this == flag3 || this == flag4;
    }

    public final boolean in(DependencyFlagImpl... flags) {
        for (DependencyFlagImpl flag : flags) {
            if (this == flag) return true;
        }
        return false;
    }

    public final boolean in(Collection<? super DependencyFlagImpl> flags) {
     ...
     */
    public static final DependencyFlagImpl[] NONE = new DependencyFlagImpl[0];
     ...
     */
    public static void validate(DependencyFlagImpl... flags) throws IllegalArgumentException {
     ...
     *         to be {@code DOWN}
     */
    static boolean isDependencyUpExpected(DependencyFlagImpl... flags) {
        for (DependencyFlagImpl flag: flags) {
     ...
     */
    static boolean propagateDemand(DependencyFlagImpl... flags) {
        for (DependencyFlagImpl flag: flags) {
            if (!flag.demand) {
                return false;
            }
     ...
     */
    static boolean isDependencyRequired(DependencyFlagImpl... flags) {
        for (DependencyFlagImpl flag: flags) {
            if (flag.enforce) {
                return true;
            }
     ...
     */
    static <T> Dependency<T> decorate(Dependency<T> dependency, ServiceBuilderImpl<?> serviceBuilder, DependencyFlagImpl... flags) {
        for (DependencyFlagImpl flag: flags) {
