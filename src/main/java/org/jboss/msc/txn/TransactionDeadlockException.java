...
public class TransactionDeadlockException extends RuntimeException {
    ...
    /**
     * Constructs a {@code TransactionDeadlockException} with no detail message. The cause is not initialized, and may
    ...
    /**
     * Constructs a {@code TransactionDeadlockException} with the specified detail message. The cause is not
    ...
    /**
     * Constructs a {@code TransactionDeadlockException} with the specified cause. The detail message is set to:
    ...
    /**
     * Constructs a {@code TransactionDeadlockException} with the specified detail message and cause.
     *
     * @param msg the detail message
     * @param cause the cause (which is saved for later retrieval by the {@link #getCause()} method)
     */
