...
public final class ServiceBatch {
     ...
     * 
     * @param definitions add a list of service definitions to the batch, in the order of the list
     * @return this batch
     */
    ...
    /**
     * Add a collection of service definitions to the batch, in the order of the collection (if ordered).
     * 
     * @param definitions add a list of service definitions to the batch, in the order of the list
     * @return this batch
     */
