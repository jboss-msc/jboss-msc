...
public final class OneParentTask_NoDeps_TwoChildTasks_WithDeps_TxnCommitted_TestCase extends AbstractTransactionTest {
    ...
    public void usecase2() throws Exception {
        ...
        if (child1e.wasCalled()) {
            assertCallOrder(parent0e, child0e, child1e, parent0v, parent0c);
        }
    }
    ...
    public void usecase4() throws Exception {
        ...
        if (child1e.wasCalled()) {
            assertCalled(child1r);
            assertCallOrder(parent0e, child0e, child1e, parent0v, child1r, parent0c);
            if (child1v.wasCalled()) {
                assertCallOrder(parent0e, child0e, child1e, parent0v, child1v, child1r, parent0c);
            }
        }
    }
