 ...
 *
 */
public class FailToStartService implements Service {
    boolean fail = false;
    final Consumer<String> providedValue;
     ...
     */
    public FailToStartService(Consumer<String> providedValue, boolean fail) {
        this.fail = fail;
