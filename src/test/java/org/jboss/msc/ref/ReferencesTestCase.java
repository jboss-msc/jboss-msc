...
import static org.jboss.msc.ref.util.Assert.assertReference;
...
import org.jboss.msc.ref.References.ReaperThread;
...
public class ReferencesTestCase {
    ...
    public void reapUnreapableReference() throws Exception {
        ...
        final Reference<Object, Void> reference = new UnreapableWeakReference(referent, reaper);
    ...
    private static final class UnreapableWeakReference extends java.lang.ref.WeakReference<Object> implements Reference<Object, Void> {
        ...
        public UnreapableWeakReference(Object referent, Reaper<Object, Void> reaper) {
        ...
        @Override
        public org.jboss.msc.ref.Reference.Type getType() {
            return Type.WEAK;
        }
    }
